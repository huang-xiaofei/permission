...
/**
 * @author tsingtao_tung Created At: 2018/1/22 上午1:02.
 */
@RestController
public class SignController extends BaseController {
	...
	public JsonRet<Object> localSignIn(@RequestParam(value = "signName", required = true) String signName,
		...
		if (!StringUtils.equals(passwd, localPasswd)) {
			return JsonRet.getErrRet(ErrCode.AUTHTICATION_PASSWD_ERROR.getCode(),
					ErrCode.AUTHTICATION_PASSWD_ERROR.getMsg());
		}
...
//        String md5 = DigestUtil.md5(String.valueOf(userId), signName, localPasswd, String.valueOf(expire));
		...
		// MjozMTAzODdmNDk3ZTgxODk0OTJmODRiZDU1OGI4ODZkNToxNTE5MTU4MTAzNTU2 非法, 篡改
		// userId
		// MTpjMDNkNDI4NWJiMGM5ZTBkNzE3OTNhMWFjOTBkMGMwZXg6MTUxOTE1NzYzNzA2OQ== 非法,篡改
		// MD5
	...
	public JsonRet<Object> weixinSignIn(@PathVariable String code) {
		...
		// 下发 Token
		long expire = System.currentTimeMillis() + this.tokenExpire;
		String md5 = DigestUtil.md5(String.valueOf(appUserId), oAuth.getOauthId(), oAuth.getAccessToken(),
