 ...
 */
public abstract class BaseCRUDController<Model extends BaseModelAndDO, Condition extends BaseQueryPage>
	...
	public JsonRet<Long> add(@JsonParam Model model) {
		System.out.println(model + "接收到数据:" + JSON.toJSONString(model));
