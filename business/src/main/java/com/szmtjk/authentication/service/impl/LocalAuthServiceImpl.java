...
@Service
public class LocalAuthServiceImpl extends BaseCRUDService<LocalAuthDO, LocalAuth, LocalAuthDBQuery, LocalAuthQuery>
	...
	@Override
	public LocalAuth queryById(Long id) {
		LocalAuth localAuth = null;
		LocalAuthDO localAuthDO = this.localAuthDAO.queryById(id);
		if (null != localAuthDO) {
			localAuth = this.localAuthConverter.toModel(localAuthDO);
		}
		return localAuth;
